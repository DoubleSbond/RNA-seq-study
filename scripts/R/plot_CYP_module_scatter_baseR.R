# Dan_mean vs Mul_mean scatter plot for CYP modules
...
draw_scatter <- function() {
  ...
  abline(log10(2), 1, lwd = 1.5, lty = 2)
  abline(log10(0.5), 1, lwd = 1.5, lty = 2)
...
png("CYP_module_Dan_vs_Mul_scatter.png", width = 2100, height = 1800, res = 300)
draw_scatter()
dev.off()

pdf("CYP_module_Dan_vs_Mul_scatter.pdf", width = 7, height = 6)
draw_scatter()
dev.off()

cat("Scatter plot generated:\n")
cat("  CYP_module_Dan_vs_Mul_scatter.png\n")
cat("  CYP_module_Dan_vs_Mul_scatter.pdf\n")
